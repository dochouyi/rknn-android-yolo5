...
Java_com_herohan_rknn_1yolov5_FieldSegment_init(JNIEnv *env, jobject thiz, jstring jmodel_path) {
...
Java_com_herohan_rknn_1yolov5_FieldSegment_detect(JNIEnv *env, jobject thiz, jobject jbitmap) {
...
JNIEXPORT jboolean JNICALL
Java_com_herohan_rknn_1yolov5_FieldSegment_release(JNIEnv *env, jobject thiz) {
